$(function () {
    ...
    function syncDrawingData(data) {
        ...
        if (data.textarea_color == 'white'){
            document.getElementById("yext_area").style.backgroundColor = 'white'
        }
         if (data.textarea_color == 'red'){
            document.getElementById("yext_area").style.backgroundColor = 'red'
        }
         if (data.textarea_color == 'yellow'){
            document.getElementById("yext_area").style.backgroundColor = 'yellow'
        }
         if (data.textarea_color == 'green'){
            document.getElementById("yext_area").style.backgroundColor = 'green'
        }
